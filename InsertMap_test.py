#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#This is a draft code to realize the function of inserting map to our web. Will be deleted after this function is added to main.
"""
Created on Sat Feb 12 23:22:26 2022
...
# Map_legen + Borough_checklist + Recycling_type_checklist + Web_link + Map
    html.Div([
        html.Div([
            # Map-legend
            html.Ul([
                html.Li("Clothing", className='circle', style={'background': '#ff00ff','color':'black',
                    'list-style':'none','text-indent': '17px'}),
                html.Li("Food", className='circle', style={'background': '#0000ff','color':'black',
                    'list-style':'none','text-indent': '17px','white-space':'nowrap'}),
                html.Li("Househould Goods", className='circle', style={'background': '#FF0000','color':'black',
                    'list-style':'none','text-indent': '17px'}),
                html.Li("Training", className='circle', style={'background': '#00ff00','color':'black',
                    'list-style':'none','text-indent': '17px'}),
            ...
            html.Label(children=['Looking for Assets: '], style=blackbold),
...
def update_figure(chosen_recycling):
    df_sub = df[(df['type'].isin(chosen_recycling))]
